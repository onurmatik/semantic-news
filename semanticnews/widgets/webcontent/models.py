"""Models for topic-related web content references."""
...
class TopicTweet(models.Model):
    """Embedded tweet associated with a topic."""
...
class TopicYoutubeVideo(models.Model):
    """Embedded YouTube video associated with a topic."""

    topic = models.ForeignKey(
        'topics.Topic', on_delete=models.CASCADE, related_name='youtube_videos'
    )
