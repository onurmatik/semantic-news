"""API endpoints for topic web content widgets."""
...
@documents_router.post("/create", response=TopicDocumentResponse)
...
@documents_router.get("/{topic_uuid}/list", response=TopicDocumentListResponse)
...
@documents_router.delete("/{document_id}", response={204: None})
...
@documents_router.post("/webpage/create", response=TopicWebpageResponse)
...
@documents_router.get("/webpage/{topic_uuid}/list", response=TopicWebpageListResponse)
def list_webpages(request, topic_uuid: str):
    ...
    webpages = TopicWebpage.objects.filter(
        topic=topic, is_deleted=False
    ).order_by("-created_at")
...
@documents_router.delete("/webpage/{webpage_id}", response={204: None})
...
@embeds_router.post('/tweet/add', response=TweetCreateResponse)
...
@embeds_router.post('/video/add', response=VideoEmbedCreateResponse)
...
__all__ = ["documents_router", "embeds_router"]
